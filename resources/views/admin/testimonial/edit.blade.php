		...
		<div class="col-lg-12">
			<div class="col-lg-6">
				...
				<fieldset>
					...
					<form method="Post" action="{{ url('/testimonial/update/'.$testimonial->id) }}" name="post" enctype="multipart/form-data">
						{{ csrf_field() }}
						...
						<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
							...
							<input type="text" name="name" class="form-control" placeholder="Name..." value="{{ old('name',$testimonial->name) }}">
